...
import com.ardu.arduinoLib.ArduinoCallback;
import com.ardu.arduinoLib.ArduinoWrapper;
...
public class MainActivity extends Activity implements OnClickListener{
	...
	public static ArduinoWrapper aw;
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.fragment_main);
		aw=new ArduinoWrapper("HC-05", "1234", this, new ArduinoCallback() {
			
			@Override
			public void OnReceive(byte[] arg0, int arg1, int arg2) {
				// TODO Auto-generated method stub
				
			}
			
			@Override
			public void OnDisconected(boolean arg0) {
				// TODO Auto-generated method stub
...
/*
		...
		Toast.makeText(this, ""+bluetoothName+ " "+bluetoothPairKey, Toast.LENGTH_LONG).show();
